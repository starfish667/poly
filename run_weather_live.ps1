...
$logFile = "logs\weather-live-$timestamp.log"
...
conda run --no-capture-output -n poly python -u weather_monitor.py --interval $interval --active-interval $activeInterval --max-concurrency $maxConcurrency --log-file $logFile @priceArgs --live
